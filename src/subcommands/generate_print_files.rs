...
pub fn generate_print_files_run(secured_poll_configuration: SecuredPollConfiguration, poll_master_key: PollMasterKey, aead_pmk: AEADKey, addresses_filename: &str, ballots_filename: &str) -> Result<()> {
